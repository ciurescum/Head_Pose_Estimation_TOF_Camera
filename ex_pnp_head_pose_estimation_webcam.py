...
P3D_RIGHT_SIDE = numpy.float32([-121.0, -77.5, 43.0]) #0
P3D_GONION_RIGHT = numpy.float32([-131.0, -77.5, -37.0]) #4
P3D_MENTON = numpy.float32([-21.0, 0.0, -74.7]) #8
P3D_GONION_LEFT = numpy.float32([-131.0, 77.5, -37.0]) #12
P3D_LEFT_SIDE = numpy.float32([-121.0, 77.5, 43.0]) #16
P3D_FRONTAL_BREADTH_RIGHT = numpy.float32([-41.0, -56.1, 58.0]) #17
P3D_FRONTAL_BREADTH_LEFT = numpy.float32([-41.0, 56.1, 58.0]) #26
P3D_SELLION = numpy.float32([-21.0, 0.0, 48.0]) #27
P3D_NOSE = numpy.float32([0.0, 0.0, 0.0]) #30
P3D_SUB_NOSE = numpy.float32([-16.0, 0.0, -4.0]) #33
P3D_RIGHT_EYE = numpy.float32([-41.0, -65.5,43.0]) #36
P3D_RIGHT_TEAR = numpy.float32([-31.0, -40.5,43.0]) #39
P3D_LEFT_TEAR = numpy.float32([-31.0, 40.5,43.0]) #42
P3D_LEFT_EYE = numpy.float32([-31.0, 65.5,43.0]) #45
#P3D_LIP_RIGHT = numpy.float32([-20.0, 65.5,-5.0]) #48
#P3D_LIP_LEFT = numpy.float32([-20.0, 65.5,-5.0]) #54
P3D_STOMION = numpy.float32([-11.0, 0.0, -27.0]) #62
#The points to track
#These points are the ones used by PnP
# to estimate the 3D pose of the face
TRACKED_POINTS = (0, 4, 8, 12, 16, 17, 26, 30, 33, 36, 39, 42, 45, 62)
...
def main():
    ...
    my_cascade = haarCascade("C:/Users/mihaela/Downloads/deepgaze-master/deepgaze-master/etc/xml/haarcascade_frontalface_alt.xml", "C:/Users/mihaela/Downloads/deepgaze-master/deepgaze-master/etc/xml/haarcascade_profileface.xml")
    #TODO If missing, example file can be retrieved from http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
    my_detector = faceLandmarkDetection('C:/Users/mihaela/Downloads/deepgaze-master/deepgaze-master/etc/shape_predictor_68_face_landmarks.dat')
